...
- Docker installed
- Fork the https://github.com/kbbr01/devsecops-jenkins-scanner [repository](https://github.com/kbbr01/devsecops-jenkins-scanner) under your GitHub account, as you will need to make changes to the repository. Shortenurl - https://bit.ly/apr26
...
4. Modify the repository name: `find . -type f -exec sed -i "s/kbbr01/$YOURID/g" {} +`
...
```py
        ...
        codebuild_behave_image_build = codebuild.Project(
            ...
            source=codebuild.Source.git_hub(
                owner="kbbr01", repo="devsecops-jenkins-scanner", branch_or_ref=branch_or_ref
            ),
